...
while True:
    ...
    results = DeepFace.find(frame, db_path="D:\Product Development\Praticing_Folder\Face_Deep\images", model_name="Facenet512", enforce_detection=False,detector_backend="mediapipe")
